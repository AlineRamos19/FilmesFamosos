...
public class MovieFavoriteAdapter extends RecyclerView.Adapter<MovieFavoriteAdapter.FavoriteHolder> {
    ...
    public void onBindViewHolder(@NonNull FavoriteHolder favoriteHolder, int position) {
        ...
        if(listMovie != null){
            ...
            favoriteHolder.date.setText("Ano de lançamento " + currentMovie.getDateRelease().substring(0,4));
            favoriteHolder.vote.setText("Nota: " + String.valueOf(currentMovie.getVoteAverage()));
